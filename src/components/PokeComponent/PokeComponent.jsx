...
export function PokeComponent({ posts }) {
  return (
    <>
        ...
        {posts && (
          <div className="pokemon-infos">
            ...
            <div className="stats-pokemon">
              <span className="life stats">
                {" "}
                {posts.stats[0].base_stat} - HP{" "}
              </span>
              <span className="attack stats">
                {" "}
                {posts.stats[1].base_stat} - ATK{" "}
              </span>
              <span className="defense stats">
                {" "}
                {posts.stats[2].base_stat} - DEF{" "}
              </span>
            </div>
          </div>
        )}
